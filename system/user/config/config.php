...
$config['debug'] = '1';
$config['cp_url'] = 'http://ee300.dev/admin.php';
...
// If you want to use a different DB for the Behat tests
// add the config here. Ideally this would be in the Test/ee.php
// file but that seems to be too late for EE to recognize the config.
if (PHP_SAPI === 'cli') {
    $config['database'] = array (
        'expressionengine' => array (
            'hostname' => '127.0.0.1',
